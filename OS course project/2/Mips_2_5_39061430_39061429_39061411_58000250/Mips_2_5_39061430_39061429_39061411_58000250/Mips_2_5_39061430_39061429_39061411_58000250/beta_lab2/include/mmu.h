...
#define PDX(va)		((((u_long)(va))>>22) & 0x03FF)//取十位页目录index
#define PTX(va)		((((u_long)(va))>>12) & 0x03FF)//取十位页表index
#define PTE_ADDR(pte)	((u_long)(pte)&~0xFFF)//取页表项对应首地址---将后12位置零

// page number field of address
#define PPN(va)		(((u_long)(va))>>12)//得到20位页目录页表
#define VPN(va)		PPN(va)

#define VA2PFN(va)		(((u_long)(va)) & 0xFFFFF000 ) // va 2 PFN for EntryLo0/1----将后12位置0
#define PTE2PT		1024
//$#define VA2PDE(va)		(((u_long)(va)) & 0xFFC00000 ) // for context----mcontext??
